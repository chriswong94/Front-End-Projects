...
Add JavaScript to make the form more user-friendly by:

- [X] adding customized and conditional behavior and interactivity.
- [X] validating user input and providing helpful error messages when the user enters invalid information into the form fields.
